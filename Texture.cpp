...
bool Texture::LoadTextureA()
{
	...
	unsigned char *texData = stbi_load(fileLocation, &width, &height, &bitDepth,STBI_rgb_alpha); 
		...
		//fileLocation: debe ser en la carpeta de Textures
		//width, heigth y bitDepth deben tener dimensiones 2 a la n o no va a funcionar el procesador
		//STBI_rgb_alpha: formato de color RGB y guardarse en imagen tipo TGA para el canal alfa
	if (!texData)
	{
